...
next_mode() { case "$(current_mode)" in safe) echo monitor ;; monitor) echo standard ;; standard) echo pokemon ;; pokemon) echo pokemonplus ;; pokemonplus) echo pixel ;; pixel) echo aggressive ;; aggressive) echo diagnostics ;; *) echo safe ;; esac; }
...
ui_print "Bluetooth Stability Helper PRO v0.8.1"
...
ui_print "Tip: edit /sdcard/Bluetooth-Stability-Helper/mode.txt to change mode without pressing Action."
